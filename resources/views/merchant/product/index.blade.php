                                ...
                                @if (count($result) > 0)
                                    ...
                                    @foreach ($result as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="icons">
                                                    <a href="" class="btn btn-sm btn-" data-toggle="tooltip"
                                                        data-placement="top" title="change status">
                                                        @if ($value['status'] == 'Active')
                                                            <i><img src={{ asset('images') . '/bulbon2.png' }}
                                                                    class="rounded-pill " height="34" alt=""></i>
                                                        @else
                                                            <img src={{ asset('images') . '/bulboff2.png' }}
                                                                class="rounded-pill " height="34" alt="">
                                                        @endif
                                                    </a>

                                                    <a href={{ route('show-product', $value['id']) }}
                                                        class="btn btn-sm btn-secondary" data-toggle="tooltip"
                                                        data-placement="top" title="show product">
                                                        <i class="icon-eye"></i>
                                                    </a>

                                                    <a href={{ route('edit-product', $value['id']) }}
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <h5>Are you sure to delete {{ $value['name'] ?? '' }} ?
                                                                    </h5>
                                                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="dlts">Delete</button>
                </div>
            </div>
        </div>
    </div>
